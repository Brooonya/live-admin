<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\phpStudy\WWW\master\public/../application/admin\view\group\index.html";i:1512461756;s:74:"D:\phpStudy\WWW\master\public/../application/admin\view\template\base.html";i:1512461756;s:85:"D:\phpStudy\WWW\master\public/../application/admin\view\template\javascript_vars.html";i:1512461756;s:71:"D:\phpStudy\WWW\master\public/../application/admin\view\group\form.html";i:1512461756;s:69:"D:\phpStudy\WWW\master\public/../application/admin\view\group\th.html";i:1512461756;s:69:"D:\phpStudy\WWW\master\public/../application/admin\view\group\td.html";i:1512567915;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<th width="">ID</th>
<th width="">名称</th>
<th width="">check_msg</th>
<th width="">check_setup</th>
            <th width="70">操作</th>
        </tr>
        </thead>
        <tbody>
...
<td><?php echo $vo['check_msg']; ?></td>
<td>
    <?php if(is_array($setup) || $setup instanceof \think\Collection || $setup instanceof \think\Paginator): $i = 0; $__LIST__ = $setup;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(in_array($v['id'],$vo['check_setup']) == true): ?>
    <?php echo $v['menu_name']; endif; endforeach; endif; else: echo "" ;endif; ?>
</td>
            <td class="f-14">
