<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:78:"D:\phpStudy\WWW\master\public/../application/admin\view\articletype\index.html";i:1512461757;s:74:"D:\phpStudy\WWW\master\public/../application/admin\view\template\base.html";i:1512461756;s:85:"D:\phpStudy\WWW\master\public/../application/admin\view\template\javascript_vars.html";i:1512461756;s:77:"D:\phpStudy\WWW\master\public/../application/admin\view\articletype\form.html";i:1512461757;s:75:"D:\phpStudy\WWW\master\public/../application/admin\view\articletype\th.html";i:1512461757;s:75:"D:\phpStudy\WWW\master\public/../application/admin\view\articletype\td.html";i:1512981523;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<td>
    <?php if(is_array($group) || $group instanceof \think\Collection || $group instanceof \think\Paginator): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(!(empty($vo['group_id']) || (($vo['group_id'] instanceof \think\Collection || $vo['group_id'] instanceof \think\Paginator ) && $vo['group_id']->isEmpty()))): if(in_array($v['id'],$vo['group_id']) == true): ?>
    <?php echo $v['name']; endif; endif; endforeach; endif; else: echo "" ;endif; ?>
</td>
            <td class="f-14">
